...
module.exports = {
  ...
  async execute(message, args, client){
    ...
    if(channelType !== ChannelType.GuildText) return message.reply('The channel must be a Text Channel.')
    ...
    const RowThree = new ActionRowBuilder()
      .addComponents([Menu])
    await channel.send({ embeds: [Embed], components: [RowOne, RowTwo, RowThree] })
  }
}